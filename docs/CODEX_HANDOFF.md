...
```text
Read D:\DACDT_2026\DANCDT\docs\CODEX_HANDOFF.md first, then continue the DACDT_2026 work from there.
```

## Project

- Main repo: `D:\DACDT_2026\DANCDT`
- Main WPF project: `D:\DACDT_2026\DANCDT\src\DACDT_2026.App`
- Solution: `D:\DACDT_2026\DANCDT\DACDT_2026.sln`
...
& "C:\Program Files\Microsoft Visual Studio\18\Community\MSBuild\Current\Bin\MSBuild.exe" `
  "D:\DACDT_2026\DANCDT\DACDT_2026.sln" `
  /p:Configuration=Debug `
  /p:Platform="Any CPU" `
  /p:OutDir="D:\DACDT_2026\DANCDT\artifacts\CodexDebug\" `
  /v:m
```
...
```powershell
$exe = 'D:\DACDT_2026\DANCDT\artifacts\CodexDebug\DACDT_2026.exe'
...
$asm = 'D:\DACDT_2026\DANCDT\artifacts\CodexDebug\DACDT_2026.exe'
...
$files = @(
  'D:\DACDT_2026\DANCDT\assets\samples\12.dxf',
  'D:\DACDT_2026\DANCDT\assets\samples\Test_G00.gcode',
  'D:\DACDT_2026\DANCDT\assets\samples\TOP_MASK_G.dxf',
  'D:\DACDT_2026\DANCDT\assets\samples\test.nc',
  'D:\DACDT_2026\DANCDT\assets\samples\logo.dxf',
  'D:\DACDT_2026\DANCDT\assets\samples\1mm.gcode',
  'D:\DACDT_2026\DANCDT\assets\samples\ytyt.dxf'
)
foreach ($f in $files) {
...
1. Run `git status --short` from `D:\DACDT_2026\DANCDT`.
