...
## Cập nhật hiện trạng kiến trúc 2026-05-03
...
| :---------------------------- | :------------------------- | :-------------- | :------------------------------------ |
| **A. ABS Linear 2**     | Positioning complete (END) | **H100**  | Dừng hẳn tại đích.               |
| (Mã gốc: 0AH)               | Continuous Positioning     | **H500**  | Dừng 1 nhịp rồi chạy tiếp.       |
|                               | Continuous Path            | **HD00**  | Chạy mượt liên tục không phanh. |
